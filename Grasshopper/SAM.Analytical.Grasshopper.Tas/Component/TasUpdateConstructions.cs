...
{
    public class TasUpdateConstructions : GH_SAMVariableOutputParameterComponent
    {
        /// <summary>
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_pathTasTBD", NickName = "pathTasTBD", Description = "A string path to a TasTBD file.", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            if (index_Successful != -1)
            {
                dataAccess.SetData(index_Successful, sAMtypes != null);
            }
        }
